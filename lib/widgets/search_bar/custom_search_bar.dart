...
class _SearchBarState<T> extends State<SearchBar<T>>
        ...
        child: Column(
          children: [
            ...
            TabBar(
              ...
              unselectedLabelColor: AppTheme.holderColor,
            ...
            Expanded(
              child: TabBarView(
                children: <Widget>[
                  _rhymeSearchTabView(list[0]),
                  _rhymeSearchTabView(list[1]),
                  _rhymeSearchTabView(list[2]),
                ],
              ),
            ),
          ],
  ...
  Widget _buildContent(BuildContext context) {
    if (_error != null) {
      ...
      if (widget.isRhymesSearch)
        return _buildTabViewRhymes(_list);
      else
  ...
  Widget _rhymeSearchTabView(RhymeSearchResults rhymeSearchResults) {
    ...
    return ListView.builder(
        ...
        itemCount: rhymeSearchResults.rhymesBag.length,
        shrinkWrap: true,
        itemBuilder: (context, index) {
          return RhymesWrapper(
            rhymes: rhymeSearchResults.rhymesBag[index],
            isVisible: (index == _showNum),
          );
        });
  }
}
