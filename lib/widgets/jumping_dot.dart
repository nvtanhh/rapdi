...
class JumpingDots extends StatefulWidget {
  ...
  const JumpingDots({Key key, this.numberOfDots = 3, this.color})
      : super(key: key);
...
class _JumpingDotsState extends State<JumpingDots>
  ...
  void _initAnimation() {
    ...
    for (int i = 0; i < widget.numberOfDots; i++) {
      _animations.add(Tween<double>(begin: 0, end: jumpHeight)
...
class DotWidget extends StatelessWidget {
  ...
  const DotWidget({Key key, this.color = Colors.black}) : super(key: key);
